...
import 'notification/employee_task_notification.dart';
          ...
          child: filtered.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final item = data["model"] as TaskModel;

                    return InkWell(
                      onTap: () {
                        // Create a TaskModel from notification data
                        ...
                        // Navigate to EmployeeTaskNotification with the task
                        Navigator.push(
                          context,
                          MaterialPageRoute(
